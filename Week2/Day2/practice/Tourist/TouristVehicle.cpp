...
TouristVehicle::TouristVehicle(std::string num, VehicleType type, int seat, float charges, Pointer ptr)
    : _vehicleNumber{num}, _type{type},_noOfSeats{seat}, _perHourBookingCharges{charges}, _permit{ptr}
{}
